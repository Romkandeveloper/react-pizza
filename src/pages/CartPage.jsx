                    ...
                    <div className="cart">
                        ...
                        <div className="content__items">

                            {
                                Object.keys(cart.items).map(item => (
                                    <CartItem
                                              key={cart.items[item].items[0].id}
                                              item={cart.items[item].items[0]}
                                              remove={handleRemoveItem}
                                              minus={handleMinusItem}
                                              plus={handlePlusItem}
                                              totalItems={cart.items[item].totalItemCount}
                                              totalSum={cart.items[item].totalItemSum}
                                    />
                                ))
                            }
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Всього піц: <b>{cart.totalItems} шт.</b> </span>
                                <span> Сума заказу: <b>{cart.totalSum} ₽</b> </span>
                            </div>
